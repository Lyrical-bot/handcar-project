...
const DIY_ITEMS = [
 //     ↓ 여기 img: '주소' 에 원하는 사진 인터넷 주소를 붙여넣으면 돼요!
  { id: 'washer',      name: '워셔액 보충',     level: '초급', img: 'https://bekomcar.com/media/img/2021/10/27/06/watermarked/90c11ac096205b0566a960147960a3ca11474770.jpeg', pos: { top: '50%', left: '5%' }, desc: '보닛을 열고 파란색 뚜껑을 찾아 워셔액을 가득 채우세요.' },
  { id: 'filter',      name: '에어컨 필터 교체', level: '초급', img: 'https://gear-up3.com/wp-content/uploads/2024/03/%EC%8B%BC%ED%83%80%ED%8E%98-TM-%EC%97%90%EC%96%B4%EC%BB%A8-%ED%95%84%ED%84%B0-%EA%B5%90%EC%B2%B4-%EB%B0%A9%EB%B2%95-1024x705.png', pos: { top: '-10%', left: '-10%' }, desc: '조수석 글로브 박스를 열고 안쪽 덮개를 제거해 필터를 교체하세요.' },
  { id: 'coolant',     name: '냉각수 보충',     level: '초급', img: 'https://bekomcar.com/media/img/2021/10/27/06/watermarked/90c11ac096205b0566a960147960a3ca11474770.jpeg', pos: { top: '70%', left: '20%' }, desc: '엔진이 식은 후 냉각수 보조 탱크의 MAX 선까지 보충하세요.' },
